...
- seed เก็บเฉพาะข้อมูลโครงสร้าง (types + users) — sites/workPlans ตัวอย่าง (รวมเคสกันบั๊กเดิม
  แผนคร่อมเดือน/แผน delay) ถูกลบออกถาวรแล้ว 14 ก.ค. 2026 ตามที่เจ้าของสั่ง
  ถ้าจะเพิ่ม fixture จับ bug กลับมา ให้ทำใน dev seed แยก อย่าปนเข้า production seed
